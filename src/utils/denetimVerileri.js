...
export const getLocalYYYYMMDD = (dateObj = new Date()) => {
...
export const getDaysPassed = (lastDate) => {
...
export const getStatusColor = (days, isActive) => {
...
export const getStatusIndicatorColor = (days, isActive) => {
...
export const getStatusLabel = (days, isActive) => {
